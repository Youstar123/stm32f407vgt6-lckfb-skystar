# STM32F407-lckfb-skystar高配版立创天空星开发板BSP说明

## 简介

该开发板是由立创开发板精心打造的一款高性价比的开发工具，**软硬件全开源**。设计上充分考虑了与多种100脚封装的单片机的兼容性。这种设计使得它不仅适用于特定的芯片，还能够适配市场上多种不同厂家生产的100脚微控制器，极大地提高了适用范围和灵活性。该BSP适配高配版立创梁山派·天空星开发板的主控芯片为STM32F407VGT6。
...
![[(../stm32f407-lckfb-skystar/figures/board.png)](README/board.png)](figures/board.png)
